...
const schema = {
    ...
    properties: {
        ...
        dtFechaSolicitud: {
            type: "string",
            format: "date",
            formatMinimum: dtFechaSistema,
            errorMessage: {
                type: "La fecha de solicitud debe ser de tipo string",
                required: "Se requiere la fecha de solicitud",
                format: "La fecha no posee un formato valido",
                formatMinimum:
                    "La fecha de la solicitud es menor a la fecha del sistema",
            },
        },
        dtFechaInicio: {
            type: "string",
            ...
            errorMessage: {
                ...
                format: "La fecha no posee un formato valido",
                formatMinimum:
                    "La fecha de inicio es menor a la fecha del sistema",
            },
        },
        dtFechaFin: {
            type: "string",
        ...
        dtFechaReingreso: {
            ...
            errorMessage: {
                ...
                format: "La fecha no posee un formato valido",
                formatMinimum:
                    "La fecha de reingreso es menor a la fecha del sistema",
            },
        },
        intNumeroDiasDisfrutar: {
            ...
            errorMessage: {
                ...
                minimum:
                    "El numero de dias a disfrutar debe ser igual o mayor a 3",
            },
        },
        intNumeroDiasCompensar: {
            ...
            errorMessage: {
                ...
                required: "Se requiere un numero de días",
                minimum:
                    "El numero de dias a compensar debe ser igual o mayor a 0",
            },
        },
        intIdEstado: {
            type: "number",
            errorMessage: {
                ...
                required:
                    "Se requiere un identificador para el estado de la solicitud",
            },
        },
        intIdTipoSolicitud: {
            type: "number",
            errorMessage: {
                ...
                required:
                    "Se requiere un identificador para el tipo de solicitud",
            },
        },
        bitOperacion: {
            type: "boolean",
