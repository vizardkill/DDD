...
class setAprobacionSolicitudVacaciones {
    ...
    async main() {
        ...
        await this.#getSolicitudCancelacion();
    ...
    async #getSolicitudCancelacion() {
        ...
        let query = await dao.getSolicitudesCanceladas({
        ...
        if (!query.data) {
            throw new Error(
                `La solicitud de cancelación con identificador #${
                    this.#objData.intIdSolicitud
                }, no existe, por favor verifica e intenta nuevamente.`
            );
        }

        this.#objSolicitudCancelacionActual = query.data[0];
    }
    ...
    async #updateSolicitudCancelacion() {
        let dao = new classInterfaceDAOSolicitudes();
    ...
    async #sendEmail() {
        ...
        }, ha modificado la solicitud de cancelación, de la solicitud de vacaciones #${
            this.#objSolicitudActual.intId
        }.</p>
        <br>
